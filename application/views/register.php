    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url(); ?>/index.php/Register">TAKEOFF CONSULTANCY</a>
...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Student Registeration</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="<?php echo base_url(); ?>index.php/Register/insert">
										...
										<div class="form-group">
                                            ...
                                            <textarea class="form-control" name="res"rows="3" ></textarea>
                                        </div>
										 <div class="form-group">
										...
										<div class="form-group">
                                            <label>Educational Qualtification</label>
                                            <input class="form-control" name="education" placeholder="Enter Current qualifications">
                                            
                                        </div>
										<div class="form-group">
                                            <label>Occupation</label>
                                            <input class="form-control" name="occ" placeholder="Enter Current Occupation">
                                            
                                        </div>
										<div class="form-group">
                                            <label>Intake</label>
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="fall" value="1">Fall
                                            </label>
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="spring" value="0">Spring
                                            </label>
                                            
                                            <input class="form-control" name="other" placeholder="Enter other intake">
                                        </div>
										<div class="form-group">
                                            <label>Applying for PR  </label>
                                            
                                                <label class="radio-inline">
                                                    <input type="radio" name="optionsRadios1" id="optionsRadios1" value="1" >Yes
                                                </label>
                                            
                                            
                                                <label class="radio-inline">
                                                    <input type="radio" name="optionsRadios1" id="optionsRadios2" value="0">No
                                                </label>
                                            </div>
											<div class="form-group">
                                            <label>Applying for Student Visa  </label>
                                            
                                                <label class="radio-inline">
                                                    <input type="radio" name="optionsRadios2" id="optionsRadios3" value="1" >Yes
                                                </label>
                                            
                                            
                                                <label class="radio-inline">
                                                    <input type="radio" name="optionsRadios2" id="optionsRadios4" value="0">No
                                                </label>
                                            </div>

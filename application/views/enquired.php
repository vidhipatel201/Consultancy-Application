...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url(); ?>index.php/enquired" >TAKEOFF CONSULTANCY</a>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Student Enquiry Details</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
 ...
 <!-- DataTables JavaScript -->
	...
	function del(id)
	{
		if(confirm("this will delete the data permanently"))
		{
		$.ajax({
			method:'POST',
			url:'<?php echo base_url(); ?>index.php/Enquired/deleteEnq',
			data:{

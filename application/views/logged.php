...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url(); ?>index.php/Logged" >TAKEOFF CONSULTANCY</a>
 ...
 <!-- DataTables JavaScript -->
	...
	function del(id)
	{
		...
		$.ajax({
			method:'POST',
			url:'<?php echo base_url(); ?>index.php/Logged/deleteEnq',
			data:{
				'id':id
			},
	...
	function confirm(id)
	{
		...
		$.ajax({
			method:'POST',
			url:'<?php echo base_url(); ?>index.php/Logged/confirm',
			data:{
				'id':id
			},
			success:function(data){

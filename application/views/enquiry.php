    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url(); ?>index.php/Enquiry">TAKEOFF CONSULTANCY</a>
...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Enquiry Form</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-green">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="<?php echo base_url(); ?>/index.php/Enquiry/insert">
										...
										<div class="form-group">
                                            <label>Applying for PR  </label>
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="optionsRadios1" id="optionsRadio" value="1" checked>Yes
                                                </label>
                                            
                                            
                                                <label class="radio-inline">
                                                    <input type="radio" name="optionsRadios1" id="optionsRadio1" value="0">No
                                                </label>
                                            </div>
											<div class="form-group">
                                            <label>Applying for Student Visa  </label>
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="optionsRadios2" id="optionsRadio2" value="1" checked>Yes
                                                </label>
                                            
                                            
                                                <label class="radio-inline">
                                                    <input type="radio" name="optionsRadios2" id="optionsRadio3" value="0">No
                                                </label>
                                            </div>
											<div class="form-group">
                                            <label>Purpose</label>
                                            <textarea class="form-control" name="purpose"rows="3" placeholder="Enter purpose of visa/enquiry"></textarea>
                                        </div>
										<div class="form-group">
                                            <label>Reference</label>
                                            <textarea class="form-control" rows="3" name="ref" placeholder="From where they knew about the consultancy"></textarea>
                                        </div>
